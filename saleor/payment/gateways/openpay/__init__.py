...
from .forms import OpenpayPaymentForm
...
def process_payment(payment_information: Dict, connection_params) -> Dict:
    ...
    # Note that is for testing by openpay_success gateway only
    charge_status = token
